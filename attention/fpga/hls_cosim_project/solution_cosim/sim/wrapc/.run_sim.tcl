...
proc run_exec {fileExe} {
	...
	set ret [catch {eval exec "./$fileExe /home/siyenga7/FPGA/testvectors/int8 | tee tmp.log" >&@ stdout} err]
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "attention_int8_kernel.autotvin.dat"
	set constFileTvOut       "attention_int8_kernel.autotvout.dat"
	set constFileHdlTvIn     "attention_int8_kernel.autohdltvin.dat"
	set constFileHdlTvOut    "attention_int8_kernel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
