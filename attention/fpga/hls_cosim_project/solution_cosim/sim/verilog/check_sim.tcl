...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.attention_int8_kernel.autotvin_gmem0.dat"
         "c.attention_int8_kernel.autotvin_gmem1.dat"
         "c.attention_int8_kernel.autotvin_gmem2.dat"
         "c.attention_int8_kernel.autotvin_Q_in.dat"
         "c.attention_int8_kernel.autotvin_K_in.dat"
         "c.attention_int8_kernel.autotvin_V_in.dat"
         "c.attention_int8_kernel.autotvin_O_out.dat"
         "c.attention_int8_kernel.autotvin_q_scale.dat"
         "c.attention_int8_kernel.autotvin_v_scale.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.attention_int8_kernel.autotvout_gmem3.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
