...
//------------------------Parameter----------------------
`define TV_IN_gmem3 "../tv/cdatafile/c.attention_int8_kernel.autotvin_gmem3.dat"
`define TV_OUT_gmem3 "../tv/rtldatafile/rtl.attention_int8_kernel.autotvout_gmem3.dat"
 parameter gmem3_ADDR_BITWIDTH = 32'd 64;
 parameter gmem3_AWUSER_BITWIDTH = 32'd 1;
 parameter gmem3_DATA_BITWIDTH = 32'd 32;
 parameter gmem3_WUSER_BITWIDTH = 32'd 1;
 parameter gmem3_ID_BITWIDTH = 32'd 1;
 parameter gmem3_RUSER_BITWIDTH = 32'd 1;
 parameter gmem3_BUSER_BITWIDTH = 32'd 1;
 parameter   FIFO_DEPTH            =   1 + 1;
 parameter   mem_page_num            =   32'd 3;
 parameter   FIFO_DEPTH_ADDR_WIDTH   =    32'd 32;
parameter gmem3_C_DATA_BITWIDTH = 32'd 16;
parameter gmem3_mem_depth = 32'd 8192;
parameter ReadReqLatency = 32'd 1;
parameter WriteReqLatency = 32'd 1;
// Input and Output
input clk;
input reset;
input  TRAN_gmem3_AWVALID;
output  TRAN_gmem3_AWREADY;
input [gmem3_ADDR_BITWIDTH - 1 : 0] TRAN_gmem3_AWADDR;
input [gmem3_ID_BITWIDTH - 1 : 0] TRAN_gmem3_AWID;
input [8 - 1 : 0] TRAN_gmem3_AWLEN;
input [3 - 1 : 0] TRAN_gmem3_AWSIZE;
input [2 - 1 : 0] TRAN_gmem3_AWBURST;
input [2 - 1 : 0] TRAN_gmem3_AWLOCK;
input [4 - 1 : 0] TRAN_gmem3_AWCACHE;
input [3 - 1 : 0] TRAN_gmem3_AWPROT;
input [4 - 1 : 0] TRAN_gmem3_AWQOS;
input [4 - 1 : 0] TRAN_gmem3_AWREGION;
input [gmem3_AWUSER_BITWIDTH - 1 : 0] TRAN_gmem3_AWUSER;
input  TRAN_gmem3_WVALID;
output  TRAN_gmem3_WREADY;
input [gmem3_DATA_BITWIDTH - 1 : 0] TRAN_gmem3_WDATA;
input [gmem3_DATA_BITWIDTH/8 - 1 : 0] TRAN_gmem3_WSTRB;
input  TRAN_gmem3_WLAST;
input  TRAN_gmem3_WID;
input [gmem3_WUSER_BITWIDTH - 1 : 0] TRAN_gmem3_WUSER;
input  TRAN_gmem3_ARVALID;
output  TRAN_gmem3_ARREADY;
input [gmem3_ADDR_BITWIDTH - 1 : 0] TRAN_gmem3_ARADDR;
input [gmem3_ID_BITWIDTH - 1 : 0] TRAN_gmem3_ARID;
input [8 - 1 : 0] TRAN_gmem3_ARLEN;
input [3 - 1 : 0] TRAN_gmem3_ARSIZE;
input [2 - 1 : 0] TRAN_gmem3_ARBURST;
input [2 - 1 : 0] TRAN_gmem3_ARLOCK;
input [4 - 1 : 0] TRAN_gmem3_ARCACHE;
input [3 - 1 : 0] TRAN_gmem3_ARPROT;
input [4 - 1 : 0] TRAN_gmem3_ARQOS;
input [4 - 1 : 0] TRAN_gmem3_ARREGION;
input  TRAN_gmem3_ARUSER;
output  TRAN_gmem3_RVALID;
input  TRAN_gmem3_RREADY;
output [gmem3_DATA_BITWIDTH - 1 : 0] TRAN_gmem3_RDATA;
output  TRAN_gmem3_RLAST;
output [gmem3_ID_BITWIDTH - 1 : 0] TRAN_gmem3_RID;
output [gmem3_RUSER_BITWIDTH - 1 : 0] TRAN_gmem3_RUSER;
output [2 - 1 : 0] TRAN_gmem3_RRESP;
output  TRAN_gmem3_BVALID;
input  TRAN_gmem3_BREADY;
output [2 - 1 : 0] TRAN_gmem3_BRESP;
output [gmem3_ID_BITWIDTH - 1 : 0] TRAN_gmem3_BID;
output [gmem3_BUSER_BITWIDTH - 1 : 0] TRAN_gmem3_BUSER;
input ready;
input done;

// Inner signals
// AW request fifo
reg    [gmem3_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [gmem3_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [gmem3_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [gmem3_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [gmem3_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [gmem3_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg    BRESP_tmp = 0;
reg    [gmem3_ID_BITWIDTH - 1 : 0] BID_tmp = 0;
reg    send_one_BRESP = 0;
reg    [31 : 0] BRESP_counter = 0;

reg [gmem3_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
reg [2 - 1:0] RRESP_tmp = 0;
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [gmem3_ID_BITWIDTH - 1 : 0] RID_tmp = 0;
reg [gmem3_DATA_BITWIDTH - 1 : 0] gmem3_mem_0 [0: gmem3_mem_depth - 1] = '{default : 'h0}; 
reg [gmem3_DATA_BITWIDTH - 1 : 0] gmem3_mem_1 [0: gmem3_mem_depth - 1] = '{default : 'h0}; 
reg [gmem3_DATA_BITWIDTH - 1 : 0] gmem3_mem_2 [0: gmem3_mem_depth - 1] = '{default : 'h0}; 
reg [31 : 0] clk_counter ;
reg [31 : 0] current_AW_req_transaction = 0 ;
reg [31 : 0] current_AR_req_transaction = -1 ;
reg write_processing = 0;
reg [gmem3_ADDR_BITWIDTH - 1 : 0] wr_processing_addr = 0;
reg [gmem3_ADDR_BITWIDTH - 1 : 0] rd_processing_addr = 0;
reg [31 : 0] wr_processing_trans_num = 0;
reg [gmem3_DATA_BITWIDTH - 1 : 0] wr_processing_data = 0;
assign TRAN_gmem3_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_gmem3_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_gmem3_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_gmem3_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_gmem3_BRESP = BRESP_tmp;
assign TRAN_gmem3_BID = BID_tmp;
assign TRAN_gmem3_RDATA = RDATA_tmp;
assign TRAN_gmem3_RRESP = RRESP_tmp;
assign TRAN_gmem3_RLAST = RLAST_tmp;
assign TRAN_gmem3_RID = RID_tmp;
assign TRAN_gmem3_RVALID = RVALID_tmp;

initial begin : initialize_offset
  integer DATA_byte_num; 
  integer c_bitwidth;
  DATA_byte_num = 0; 
  c_bitwidth = gmem3_C_DATA_BITWIDTH;
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_gmem3_AWREADY & TRAN_gmem3_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_gmem3_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_gmem3_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_gmem3_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_gmem3_AWBURST; 
            FIFO_AW_req_ID[FIFO_AW_req_ptr_w]    =   TRAN_gmem3_AWID; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_gmem3_ARREADY & TRAN_gmem3_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_gmem3_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_gmem3_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_gmem3_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_gmem3_ARBURST; 
            FIFO_AR_req_ID[FIFO_AR_req_ptr_w]    =   TRAN_gmem3_ARID; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_gmem3_WREADY & TRAN_gmem3_WVALID) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_gmem3_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_gmem3_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_gmem3_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_gmem3_AWVALID && TRAN_gmem3_AWREADY && ((FIFO_AW_req_ptr_w - FIFO_AW_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_gmem3_ARVALID && TRAN_gmem3_ARREADY && ((FIFO_AR_req_ptr_w - FIFO_AR_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_gmem3_WVALID && TRAN_gmem3_WREADY && ((FIFO_WDATA_req_ptr_w - FIFO_WDATA_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_gmem3_WVALID && TRAN_gmem3_WREADY && TRAN_gmem3_WLAST && ((FIFO_WDATA_size_ptr_w - FIFO_WDATA_size_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_gmem3_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_gmem3_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [gmem3_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [gmem3_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [gmem3_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem3_mem_depth) begin
                $display ("/home/siyenga7/FPGA/hls_cosim_project/solution_cosim/sim/verilog/AESL_axi_master_gmem3.v: Write request address %d exceed AXI master gmem3 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem3_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AW_req_BURST_tmp === 1) begin
                ...
                while (counter != output_length + 1) begin
                    if (FIFO_WDATA_req_empty != 1) begin 
                            ...
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = gmem3_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        1 : WDATA_tmp[j] = gmem3_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        2 : WDATA_tmp[j] = gmem3_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                        ...
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : gmem3_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            1 : gmem3_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            2 : gmem3_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
                    ...
                    if (FIFO_WDATA_req_empty != 1) begin 
                        ...
                        for (i = 0 ; i < data_byte_size; i = i + 1) begin
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = gmem3_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        1 : WDATA_tmp[j] = gmem3_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        2 : WDATA_tmp[j] = gmem3_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        default: $display("The page_num of AXI write is not valid!");
                                    endcase
                                end
                            end
                        ...
                        wr_processing_data = WDATA_tmp;
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : gmem3_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            1 : gmem3_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            2 : gmem3_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
...
initial begin : AR_request_proc
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem3_mem_depth) begin
                $display ("/home/siyenga7/FPGA/hls_cosim_project/solution_cosim/sim/verilog/AESL_axi_master_gmem3.v: Read request address %d exceed AXI master gmem3 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem3_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= gmem3_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            1 : RDATA_tmp <= gmem3_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            2 : RDATA_tmp <= gmem3_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_gmem3_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= gmem3_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            1 : RDATA_tmp <= gmem3_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            2 : RDATA_tmp <= gmem3_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            default: $display("The page_num of AXI read is not valid!");
                        endcase
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
...
initial begin : read_file_process 
  ...
  integer mem_page; 
  integer gmem3_bitwidth; 
  reg [16 - 1 : 0] token_tmp; 
  reg [gmem3_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  gmem3_bitwidth = gmem3_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (gmem3_bitwidth , factor);
  fp = $fopen(`TV_IN_gmem3,"rb"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_gmem3); 
      $finish; 
  end 
  ...
  while (trans_depth != 64'h5a5aa5a50f0ff0f0)  begin
      ...
      mem_tmp [gmem3_DATA_BITWIDTH - 1: 0] = 0;
      for(i = 0; i < gmem3_mem_depth; i = i + 1) begin 
          ...
          if (factor == 4) begin
              ...
              if (i%factor == 3) begin
                  ...
                  case(mem_page)
                      0 : gmem3_mem_0[i/factor] = mem_tmp;
                      1 : gmem3_mem_1[i/factor] = mem_tmp;
                      2 : gmem3_mem_2[i/factor] = mem_tmp;
          ...
          if (factor == 1) begin
              mem_tmp = token_tmp;
              case(mem_page)
                  0 : gmem3_mem_0[i] = mem_tmp;
                  1 : gmem3_mem_1[i] = mem_tmp;
                  2 : gmem3_mem_2[i] = mem_tmp;
                  default: $display("The page_num of read file is not valid!");
              endcase
              mem_tmp [gmem3_DATA_BITWIDTH - 1: 0] = 0;
          end
...
initial begin : write_file_proc 
  ...
  integer mem_page; 
  integer gmem3_bitwidth; 
  reg [gmem3_C_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  reg [gmem3_DATA_BITWIDTH - 1 : 0] tmp_data;
  reg [63:0] bin_data;
  transaction_num = 0; 
  gmem3_bitwidth = gmem3_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (gmem3_bitwidth , factor);
  while(1) begin 
      ...
      mem_page = transaction_num % mem_page_num ;
      # 0.1;
      fp = $fopen(`TV_OUT_gmem3, "ab"); 
      if(fp == 0) begin       // Failed to open file 
          $display("Failed to open file \"%s\"!", `TV_OUT_gmem3); 
          $finish; 
      end 
      bin_data = gmem3_mem_depth;
      write_binary(fp,bin_data,64);
      for(i = 0; i < (gmem3_mem_depth - gmem3_mem_depth % factor); i = i + 1) begin 
          if (factor == 4) begin
              case(mem_page)
                  0 : tmp_data = gmem3_mem_0[i/factor];
                  1 : tmp_data = gmem3_mem_1[i/factor];
                  2 : tmp_data = gmem3_mem_2[i/factor];
          ...
          if (factor == 1) begin
              case(mem_page)
                  0 : mem_tmp = gmem3_mem_0[i];
                  1 : mem_tmp = gmem3_mem_1[i];
                  2 : mem_tmp = gmem3_mem_2[i];
                  default: $display("The page_num of write file is not valid!");
              endcase
          bin_data = mem_tmp;
          write_binary(fp,bin_data,16);
      ...
      if (factor == 4) begin
          case(mem_page)
              0 : tmp_data = gmem3_mem_0[gmem3_mem_depth/factor];
              1 : tmp_data = gmem3_mem_1[gmem3_mem_depth/factor];
              2 : tmp_data = gmem3_mem_2[gmem3_mem_depth/factor];
              default: $display("The page_num of write file is not valid!");
          endcase
          if ((gmem3_mem_depth - 1) % factor == 2) begin
          ...
          if ((gmem3_mem_depth - 1) % factor == 1) begin
              bin_data = tmp_data[7:0];
              write_binary(fp,bin_data,8);
              bin_data = tmp_data[15:8];
              write_binary(fp,bin_data,8);
          end
          if ((gmem3_mem_depth - 1) % factor == 0) begin
              bin_data = tmp_data;
              write_binary(fp,bin_data,8);
          end
      end
      if (factor == 2) begin
          if ((gmem3_mem_depth - 1) % factor == 0) begin
              case(mem_page)
                  0 : tmp_data = gmem3_mem_0[gmem3_mem_depth/factor][15:0];
                  1 : tmp_data = gmem3_mem_1[gmem3_mem_depth/factor][15:0];
                  2 : tmp_data = gmem3_mem_2[gmem3_mem_depth/factor][15:0];
                  default: $display("The page_num of write file is not valid!");
              endcase
              bin_data = tmp_data;
              write_binary(fp,bin_data,16);
