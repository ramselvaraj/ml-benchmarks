...
`define AUTOTB_DUT      attention_int8_kernel
`define AUTOTB_DUT_INST AESL_inst_attention_int8_kernel
`define AUTOTB_TOP      apatb_attention_int8_kernel_top
`define AUTOTB_LAT_RESULT_FILE "attention_int8_kernel.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "attention_int8_kernel.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_attention_int8_kernel_top
...
`define AESL_DEPTH_Q_in 1
`define AESL_DEPTH_K_in 1
`define AESL_DEPTH_V_in 1
`define AESL_DEPTH_O_out 1
`define AESL_DEPTH_q_scale 1
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.attention_int8_kernel.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1_out_wrapc  "../tv/rtldatafile/rtl.attention_int8_kernel.autotvin_gmem1.dat"
`define AUTOTB_TVIN_gmem2_out_wrapc  "../tv/rtldatafile/rtl.attention_int8_kernel.autotvin_gmem2.dat"
`define AUTOTB_TVIN_Q_in_out_wrapc  "../tv/rtldatafile/rtl.attention_int8_kernel.autotvin_Q_in.dat"
`define AUTOTB_TVIN_K_in_out_wrapc  "../tv/rtldatafile/rtl.attention_int8_kernel.autotvin_K_in.dat"
`define AUTOTB_TVIN_V_in_out_wrapc  "../tv/rtldatafile/rtl.attention_int8_kernel.autotvin_V_in.dat"
`define AUTOTB_TVIN_O_out_out_wrapc  "../tv/rtldatafile/rtl.attention_int8_kernel.autotvin_O_out.dat"
`define AUTOTB_TVIN_q_scale_out_wrapc  "../tv/rtldatafile/rtl.attention_int8_kernel.autotvin_q_scale.dat"
`define AUTOTB_TVIN_v_scale_out_wrapc  "../tv/rtldatafile/rtl.attention_int8_kernel.autotvin_v_scale.dat"
`define AUTOTB_TVOUT_gmem3  "../tv/cdatafile/c.attention_int8_kernel.autotvout_gmem3.dat"
`define AUTOTB_TVOUT_gmem3_out_wrapc  "../tv/rtldatafile/rtl.attention_int8_kernel.autotvout_gmem3.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 505495;
parameter LENGTH_Q_in = 1;
parameter LENGTH_K_in = 1;
parameter LENGTH_V_in = 1;
parameter LENGTH_O_out = 1;
parameter LENGTH_q_scale = 1;
parameter LENGTH_v_scale = 1;
parameter LENGTH_gmem0 = 8192;
parameter LENGTH_gmem1 = 8192;
parameter LENGTH_gmem2 = 8192;
parameter LENGTH_gmem3 = 8192;
...
reg end_Q_in;
reg [31:0] size_Q_in;
reg [31:0] size_Q_in_backup;
reg end_K_in;
reg [31:0] size_K_in;
reg [31:0] size_K_in_backup;
reg end_V_in;
reg [31:0] size_V_in;
reg [31:0] size_V_in_backup;
reg end_O_out;
reg [31:0] size_O_out;
reg [31:0] size_O_out_backup;
reg end_q_scale;
reg [31:0] size_q_scale;
reg [31:0] size_q_scale_backup;
reg end_v_scale;
