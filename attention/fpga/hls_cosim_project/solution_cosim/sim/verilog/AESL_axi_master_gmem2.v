...
//------------------------Parameter----------------------
`define TV_IN_gmem2 "../tv/cdatafile/c.attention_int8_kernel.autotvin_gmem2.dat"
`define TV_OUT_gmem2 "../tv/rtldatafile/rtl.attention_int8_kernel.autotvout_gmem2.dat"
 parameter gmem2_ADDR_BITWIDTH = 32'd 64;
 parameter gmem2_AWUSER_BITWIDTH = 32'd 1;
 parameter gmem2_DATA_BITWIDTH = 32'd 32;
...
parameter gmem2_C_DATA_BITWIDTH = 32'd 8;
parameter gmem2_mem_depth = 32'd 8192;
...
reg    BRESP_tmp = 0;
reg    [gmem2_ID_BITWIDTH - 1 : 0] BID_tmp = 0;
...
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [gmem2_ID_BITWIDTH - 1 : 0] RID_tmp = 0;
reg [gmem2_DATA_BITWIDTH - 1 : 0] gmem2_mem_0 [0: gmem2_mem_depth - 1] = '{default : 'h0}; 
reg [gmem2_DATA_BITWIDTH - 1 : 0] gmem2_mem_1 [0: gmem2_mem_depth - 1] = '{default : 'h0}; 
reg [gmem2_DATA_BITWIDTH - 1 : 0] gmem2_mem_2 [0: gmem2_mem_depth - 1] = '{default : 'h0}; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_gmem2_AWREADY & TRAN_gmem2_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            ...
            FIFO_AW_req_ID[FIFO_AW_req_ptr_w]    =   TRAN_gmem2_AWID; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_gmem2_ARREADY & TRAN_gmem2_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            ...
            FIFO_AR_req_ID[FIFO_AR_req_ptr_w]    =   TRAN_gmem2_ARID; 
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem2_mem_depth) begin
                $display ("/home/siyenga7/FPGA/hls_cosim_project/solution_cosim/sim/verilog/AESL_axi_master_gmem2.v: Write request address %d exceed AXI master gmem2 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem2_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem2_mem_depth) begin
                $display ("/home/siyenga7/FPGA/hls_cosim_project/solution_cosim/sim/verilog/AESL_axi_master_gmem2.v: Read request address %d exceed AXI master gmem2 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem2_mem_depth); 
                $finish;
            end
