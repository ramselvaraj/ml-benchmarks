...
extern "C"
void attention_int8_kernel_hw_stub_wrapper(void*, void*, void*, void*, float, float);

extern "C"
void apatb_attention_int8_kernel_hw(void* __xlx_apatb_param_Q_in, void* __xlx_apatb_param_K_in, void* __xlx_apatb_param_V_in, void* __xlx_apatb_param_O_out, float __xlx_apatb_param_q_scale, float __xlx_apatb_param_v_scale)
{
  hls::sim::Byte<4> __xlx_offset_byte_param_Q_in;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_Q_in),
#endif
  };
  port0.param = &__xlx_offset_byte_param_Q_in;

  hls::sim::Byte<4> __xlx_offset_byte_param_K_in;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_K_in),
#endif
  };
  port1.param = &__xlx_offset_byte_param_K_in;

  hls::sim::Byte<4> __xlx_offset_byte_param_V_in;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_V_in),
#endif
  };
  port2.param = &__xlx_offset_byte_param_V_in;

  hls::sim::Byte<4> __xlx_offset_byte_param_O_out;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_O_out),
#endif
  };
  port3.param = &__xlx_offset_byte_param_O_out;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_q_scale),
#endif
  };
  port4.param = &__xlx_apatb_param_q_scale;
  ...
  port5.param = &__xlx_apatb_param_v_scale;
  ...
  port6.param = { __xlx_apatb_param_Q_in };
  port6.nbytes = { 65536 };
  port6.offset = {  };
  ...
  port7.param = { __xlx_apatb_param_K_in };
  port7.nbytes = { 65536 };
  port7.offset = {  };
  ...
  port8.param = { __xlx_apatb_param_V_in };
  port8.nbytes = { 65536 };
  port8.offset = {  };
  ...
  port9.param = { __xlx_apatb_param_O_out };
  port9.nbytes = { 131072 };
  port9.offset = {  };
  port9.hasWrite = { true };
